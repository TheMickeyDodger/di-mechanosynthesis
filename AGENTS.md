...
Two further restrictions are matters of method or scope rather than of missing evidence. Reported per-interaction
counts are never multiplied into build-success probabilities. Installation commands, releases or claims of
readiness are not given for software that this repository does not provide.
