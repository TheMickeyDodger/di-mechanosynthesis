...
| `AGENTS.md` | `12e85a0d8147a528a9bf21109f0c76f6beeb5bd694ea286282cf1061d809cc06` | New for the public export. It is not copied from any private operating contract. |
| `README.md` | `1b3f20c1f6c968b4070477d85b6840c95e2bc49bc0e954e786387482b1216828` | New for the public export. It cites and paraphrases the benchmark and related preprints and copies no source file. |
| `docs/SOURCES.md` | `58ef093e5d33406b1c4fc5676c99f5c38ef0d3d8cb8c5dab8f2044dbb58cf7e0` | New source catalogue compiled from the sources inspected in the current review, the project's retrieval records (cited by public URL only) and the link checks of 2026-09-23. Each entry states whether it was inspected, link-checked or recorded. It contains no computed values. |
...
The data from the retired outcome chart remain tabulated in the README and in `docs/benchmark.md`.
